                ...
                if (satnt === "expanded" || satnt === "compact") {
                    ...
                    if (mt === "click") {
                        $(window).on("load", function () {
                            $(".mlete-navbar").mCustomScrollbar({ axis: "y", autoHideScrollbar: false, scrollInertia: 100, theme: "minimal" });
                            $(".sidebar_toggle a").click(function (charvi) {
                                ...
                                if (el.hasClass("mCS_destroyed")) {
                                    el.mCustomScrollbar({ axis: "y", autoHideScrollbar: false, scrollInertia: 100, theme: "minimal" });
                                } else {
