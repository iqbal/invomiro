...
var module_catalog_search_combo = new ej.dropdowns.ComboBox({
    popupHeight: '230px',
    index: 2,
    cssClass: 'e-outline',
...
module_catalog_search_combo.appendTo('#module-catalog-search-combo');

var module_catalog_search_key = new ej.inputs.TextBox({
    placeholder: 'search keyword',
    cssClass: 'e-outline',
    floatLabelType: 'Always'
});
module_catalog_search_key.appendTo('#module-catalog-search-key');
...
var module_catalog_grid_search = new ej.grids.Grid({
    ...
    showColumnMenu: true,
    columns: [
        { field: 'itemnbr', headerText: 'Item Number', width: 120 },
        { field: 'shortdesc', headerText: 'Short Desc', width: 150 },
        { field: 'longdesc', headerText: 'Long Desc', width: 130 },
        { field: 'source1', headerText: 'Raw Data #1', width: 120 },
        { field: 'source2', headerText: 'Raw Data #2', width: 120 },
        { field: 'refnbr', headerText: 'PN/RN', width: 150 }
    ],
    pageSettings: { pageCount: 5 }
});
module_catalog_grid_search.appendTo('#module-catalog-grid-search');


// panel material data specification
...
modul_catalog_panel_desc.appendTo('#module-catalog-desc-panel');


// sub panel material item status
...
msgstat_item.appendTo('#mmodule-catalog-status-item');


// sub panel material item image
...
var module_catalog_grid_characteristic = new ej.grids.Grid({
    ...
    allowResizing: true,
    columns: [
        { field: 'characteristic', headerText: 'characteristic', width: 120 },
        { field: 'characteristic_value', headerText: 'value', width: 150 },
        { field: 'characteristic_type', headerText: 'type', width: 60 }
    ]
});
module_catalog_grid_characteristic.appendTo('#module-catalog-grid-characteristic');

// sub panel material item partnumber
...
var module_catalog_grid_pn = new ej.grids.Grid({
    ...
    allowResizing: true,
    columns: [
        { field: 'manufacturer', headerText: 'manufacturer / vendor', width: 150 },
        { field: 'partnumber', headerText: 'part number', width: 100 },
        { field: 'priority', headerText: 'priority', width: 60 }
    ]
});
module_catalog_grid_pn.appendTo('#module-catalog-grid-pn');

// sub panel material item asset register
...
var module_catalog_grid_assetreg = new ej.grids.Grid({
    ...
    allowResizing: true,
    columns: [
        { field: 'parrent_equipment', headerText: 'parrent equipment', width: 150 },
        { field: 'id_asset_parrent', headerText: 'id_asset', width: 100 },
        { field: 'parrent_asset_level', headerText: 'level', width: 60 }
    ]
});
module_catalog_grid_assetreg.appendTo('#module-catalog-grid-assetreg');

// sub panel material item mrp data
...
var module_catalog_grid_mrp = new ej.grids.Grid({
    ...
    allowResizing: true,
    columns: [
        { field: 'mrp_class', headerText: 'MRP classification', width: 150 },
        { field: 'mrp_value', headerText: 'value', width: 100 },
        { field: 'mrp_type', headerText: 'type', width: 60 }
    ]
});
module_catalog_grid_mrp.appendTo('#module-catalog-grid-mrp');


// sub panel material item bin loc
