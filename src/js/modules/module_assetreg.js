var module_assetreg_treegrid = new ej.treegrid.TreeGrid({
  datasource: $.ajax({
    type: "GET",
    url: "http://localhost:8008/asset_mgt/getTreeAsset/",
...
var module_assetreg_detail_img_tab = new ej.navigations.Tab({
  items: [
      {
          header: { 'text': 'image' },
          content: '#module-assetreg-desc-panel_tab-image'
      },
      {
          header: { 'text': '2D Drawing' },
          content: '#module-assetreg-desc-panel_tab-2d_drawing'
      },
      {
...
var module_assetreg_grid_sub_asset = new ej.grids.Grid({
  dataSource: new ej.data.DataManager({
      ...
      type: 'GET',
      url: 'http://localhost:8008/asset_mgt/getSubAsset/',
      crossDomain: true
